...
baud_rate_var = StringVar(root)
baud_rate_var.set("9600")  # default value
baud_rates = ["9600", "115200", "38400", "57600"]
baud_rate_menu = OptionMenu(root, baud_rate_var, *baud_rates)
